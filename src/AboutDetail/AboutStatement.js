...
function AboutStatement() {
  return (
    <div className='aboutStatement'>
      <h1>About This (Not-so-serious-yet-pretty-prolific) Website</h1>
      <br/>
      <p>
        ...
        and is worth a gamble. Just like that, I moved to San Francisco.
      </p><br /><p>
       Back in 2010, I struggled to speak English, and being placed in an all-immigrant high school did not help
       with acculturation. In 2014, my acrobatic endeavor somewhat came to an end after competing as part of Team USA, 
      ...
      <p>
        In 2016-2017 I decided to take college more seriously.
      </p><p>
        In 2017-2018, I took other preparatory courses on track for Kinesiology in hopes to finish the degree, but then realized that
        studying Chemistry and studying and taking exams was somewhat rewarding, and the act of self-teaching/learning was also fun. 
      </p><br/><p>
        While it did take me roughly 2-3 years
        to realize that I wanted to pursue a major of STEM discipline, I was not exposed to Differential Calculus until in 2018. Since then
